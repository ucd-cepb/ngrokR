##### NOTE THIS IS MOD FROM https://raw.githubusercontent.com/rundel/livecode/master/R/file_stream_server.R
...
serve_file = function(file, ip, port, interval = 1,auto_save = TRUE,
                      open_browser = TRUE) {
